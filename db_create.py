...
print("Embedding modeli başlatılıyor...")
model_name = "sentence-transformers/all-mpnet-base-v2"

device= "cuda" if torch.cuda.is_available() else "cpu"   #Eğer GPU müsait ise "gpu" değilse "cpu" kullan.
...
print("Yeni vektör veritabanı oluşturuluyor. Bu işlem BİRAZ UZUN sürebilir...")
