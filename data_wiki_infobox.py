...
# Sadece bu başlıkların altındaki paragrafları istiyoruz
ELMAS_BASLIKLAR = [
...
def scrape_wiki_page(page_url, file_prefix):
    ...
    try:
        ...
        # Adım 1: Infobox'ı Bul, Kaydet ve Yok Et
        ...
        # Adım 2: Gerekli Başlıkları ve İçeriklerini Çek.
        wiki_text_parcalari = []
        ...
        if main_text.strip():
            ...
            print(f"✅ {file_prefix}_wiki.txt kaydedildi.")
        else:
            print(f"⚠️ {file_prefix} sayfasında gerekli başlık bulunamadı.")

    except requests.exceptions.RequestException:
        print(f"⚠️ {file_prefix} sayfası bulunamadı veya bir hata oluştu. Atlanıyor.")

# --- Pokemon İsimlerini Çeken Fonksiyon --- 
